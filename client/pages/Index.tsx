  ...
  return (
    <div className="min-h-screen bg-bg-cream overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-12 h-16 sm:h-20 md:h-24 flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center">
            <img
              src="https://pub-7f2dabc5b5c14daab8ff8b19e15a314e.r2.dev/Beahive%20Official%20Logo%20Color%20PNG.png"
...
<HeroSection/>
 ...
 <span className="font-bold"> start with one hello.</span>
                  </p>
            ...
            <div className="flex-shrink-0 w-[280px] h-[176px] rounded-[21px] border border-border-pink bg-white shadow-md p-6 flex flex-col items-center justify-center gap-2">
              ...
              <p className="text-xs text-center text-text-dark">
                "I joined for the events and found a second circle of friends."
              </p>
            </div>
            ...
            <div className="flex-shrink-0 w-[280px] h-[176px] rounded-[21px] border border-border-pink bg-white shadow-md p-6 flex flex-col items-center gap-2">
              ...
              <h3 className="font-kraskario text-3xl capitalize text-center">Girls' Day Out</h3>
              <p className="text-base text-center text-text-dark/50 font-semibold">
                Because good memories are better when shared
              </p>
            </div>
            ...
            <div className="flex-shrink-0 w-[280px] h-[176px] rounded-[21px] border border-border-pink bg-white shadow-md p-1.5 overflow-hidden">
              <div className="relative h-full rounded-2xl overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/60 to-transparent">
                  <h3 className="text-white font-manrope text-sm font-bold text-center">Built For Women</h3>
                  <p className="text-white text-xs text-center font-semibold">
                    "  A community where you can show up exactly as you are."
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-shrink-0 w-[280px] h-[176px] rounded-[21px] border border-border-pink bg-white shadow-md p-6 relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-4">
                <h3 className="font-kraskario text-3xl capitalize">Discover New Interests
</h3>
        ...
        <div className="scroller" data-animated="true">
          <div className="scroller-inner flex gap-5 animate-slide-right">
            ...
            <div className="flex-shrink-0 w-[280px] h-[175px] p-3 rounded-[21px] border border-border-pink bg-white shadow-md">
              <div className="flex items-center gap-3 h-full">
                ...
                <div className="flex flex-col justify-center gap-3 flex-1">
                  ...
                  <p className="text-xs text-text-dark/80 text-center">
                     Explore hobbies, clubs, and experiences <span className="font-bold">you've always wanted to try.</span>
                  </p>
                  {/* <button className="w-full py-2 rounded-full bg-gradient-primary text-white text-xs font-bold">
                    Join Now
                  </button> */}
            ...
            <div className="flex-shrink-0 w-[280px] h-[176px] rounded-[21px] border border-border-pink bg-white shadow-md p-6 flex flex-col items-center justify-center gap-2">
              ...
              <p className="text-xs text-center text-text-dark">
                "Book Clubs. Brunches. Movie Nights."
              </p>
            </div>
            ...
            <div className="flex-shrink-0 w-[280px] h-[176px] rounded-[21px] border border-border-pink bg-white shadow-md p-6 flex flex-col items-center gap-2">
              ...
              <h3 className="font-kraskario text-3xl capitalize text-center">Grow With Every Meetup</h3>
              <p className="text-base text-center text-text-dark/50 font-semibold ">
            ...
            <div className="flex-shrink-0 w-[280px] h-[176px] rounded-[21px] border border-border-pink bg-white shadow-md p-1.5 overflow-hidden">
              <div className="relative h-full rounded-2xl overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/60 to-transparent">
                  ...
                  <p className="text-white text-xs text-center font-semibold">
                    " A Place To Belong
,Find your community, your confidence, and your people."
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-shrink-0 w-[280px] h-[176px] rounded-[21px] border border-border-pink bg-white shadow-md p-6 relative overflow-hidden">
              ...
              />
              <div className="relative z-10 space-y-4">
                <h3 className="font-kraskario text-3xl capitalize">Your Next Favorite Community Is Waiting
</h3>
                <p className="text-sm text-text-dark/70 font-semibold max-w-[160px]">
                 Join women who support, inspire, and celebrate each other. 
                </p>
              </div>
            </div>
          </div>
  ...
  <div className="max-w-[1440px] mx-auto px-6 md:px-16 grid md:grid-cols-2 gap-20 items-center">
    ...
    <div className="space-y-8">
      <h2 className="font-kraskario text-5xl md:text-7xl lg:text-8xl leading-[1.1] text-text-dark">
        Connection Built on <span className="gradient-text1">Belonging</span>
      </h2>

      <div className="space-y-6">
        <div className="space-y-3">
          <h3 className="font-kraskario text-2xl md:text-4xl">
            "Beyond <span className="text-gray-400">Small Talk</span>"
          </h3>
          <p className="font-manrope text-base text-text-dark/60">
           Meaningful conversations that leave you feeling understood, inspired, and connected.
          </p>
        </div>

        <div className="space-y-3">
          <h3 className="font-kraskario text-2xl md:text-4xl">
            "A Space  <span className="text-gray-400">to Grow</span>"
          </h3>
          <p className="font-manrope text-base text-text-dark/60">
            Explore new passions, build confidence, and discover new sides of yourself.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="font-manrope text-base md:text-[18px] text-text-dark/80">
            Create genuine bonds with women who become part of your journey.
...
>
  Moments That Bring Women Together
...
>
  <span className="gradient-text1">Join the Baehive Club</span>
</button>
